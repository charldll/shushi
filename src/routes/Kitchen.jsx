    ...
    <div className="p-8 bg-gray-100 min-h-screen flex flex-col items-center">
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 border w-80 mt-6">
        ...
        <div className="mt-4 flex gap-2">
          <button className="bg-red-400 text-white px-9 py-3 rounded hover:bg-red-600 transition duration-700 ease-in-ou">
            Anuluj
          </button>
          <button className="bg-green-400 text-white px-9 py-3 rounded hover:bg-green-600 transition duration-700 ease-in-ou">
            Zaakceptuj
          </button>
        </div>
      </div>
